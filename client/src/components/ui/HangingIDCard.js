        ...
        >
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="flex justify-center">
              <div
                className={`${isMobile ? "w-24 h-24" : "w-28 h-28"} rounded-2xl overflow-hidden shadow-2xl ${
                  isDark
              ...
              >
                <div className="w-full h-full relative">
                  ...
                  <div
                    ...
                    style={{
                      display: personalInfo?.profileImage || personalInfo?.avatarUrl ? "none" : "flex",
                    }}
                  >
                    👨‍💻
                  </div>
            ...
            <div className="text-center space-y-3 ">
              ...
              >
                ...
                >
                  <span>✉️</span>
                  <span className="font-mono text-xs">{personalInfo?.email || "john@techcorp.com"}</span>
                </div>
                <div
                  className={`flex items-center justify-center space-x-2 ${isDark ? "text-gray-300" : "text-gray-600"}`}
                >
